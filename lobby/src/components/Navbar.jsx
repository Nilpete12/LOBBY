...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 w-full z-40 bg-[#edf0ec]/80 backdrop-blur-xl border-b border-white/60 shadow-sm">
        <div className="max-w-7xl mx-auto px-5 md:px-6 h-16 md:h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 items-center gap-8 text-sm font-semibold text-slate-600">            
            ...
            <Show when="signed-out">
              <Link href="/search" className="hover:text-[#627568] transition">Find a Ride</Link>
              <Link href="/drive" className="hover:text-[#627568] transition">For Drivers</Link>
              <Link href="/support" className="hover:text-[#627568] transition">Support</Link>
            </Show>
            ...
            <Show when="signed-in">
              ...
              {userRole !== "driver" && (
                <>
                  <Link href="/search" className="hover:text-[#627568] transition">All Services</Link>
                  <Link href="/favourites" className="hover:text-[#627568] transition">Favourites</Link>
                  <Link href="/account" className="hover:text-[#627568] transition">Profile</Link>
                  <Link href="/support" className="hover:text-[#627568] transition">Support</Link>
                </>
              )}
              ...
              {userRole === "driver" && (
                <>
                  <Link href="/drive/dashboard" className="hover:text-[#627568] transition">Profile</Link>
                  <Link href="/drive/earnings" className="hover:text-[#627568] transition">Analytics</Link>
                  <Link href="/drive/TripHistory" className="hover:text-[#627568] transition">Trip History</Link>
                  <Link href="/support" className="hover:text-[#627568] transition">Support</Link>
                </>
              )}
            </Show>
          ...
          <div className="flex items-center gap-5">
            ...
            <Show when="signed-out">
              <SignInButton mode="modal">
                <button className="text-sm font-bold text-slate-900 hover:text-[#627568] transition">
                  Log In
                </button>
              </SignInButton>
              ...
              <Link
                ...
                className="
                  hidden md:block
                  bg-linear-to-r from-[#171d1a] to-[#3a463f]
      ...
      <div className="md:hidden fixed bottom-5 inset-x-6 z-50 mx-auto max-w-sm transition-colors duration-300">
        <div className={`
          ...
          ${isDarkBg 
            ...
            : 'bg-white/60 border-white/70 shadow-[#171d1a]/10' // LIGHT MODE GLASS
          }
        `}>         
